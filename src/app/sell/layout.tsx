...
export default function SellLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <div className="sticky top-10 z-40 border-b border-black/[0.06] bg-canvas/80 backdrop-blur-2xl backdrop-saturate-[1.8]">
        <div className="mx-auto flex h-11 max-w-[980px] items-center justify-between gap-6 px-5">
